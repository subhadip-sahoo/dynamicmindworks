		...
		<section class="inner-main-container clearfix">
			<div class="left-container">			
				<header class="content-title page-title">
					<?php $page_id = 22;?>
					<h1><span><?php echo get_the_title($page_id);?></span></h1>
					<p class="sub-text"><?php $page = get_page($page_id); echo $page->post_content;?></p>
				</header>
							...
							<div class="blog-list-content clearfix">
								<figure class="blog-image">
									<?php if(has_post_thumbnail()):?>										
										...
										<img src="<?php echo $image['url'];?>" alt="Images" width="271" height="198" >
									<?php else:?>
										<img src="<?php echo get_template_directory_uri();?>/images/no-image.png" alt="No Image" width="271" height="198" />
									<?php endif;?>									
								</figure>
